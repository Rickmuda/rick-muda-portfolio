...
const messages = {
  en: {
    ...
    scoreboardNameRejected: "That name isn't allowed - try something else.",
    scoreboardNewBest: "New personal best! Add it to the leaderboard:",
    settings: "Settings",
    ...
    lh: "LunarHome",
    lhDescription: "My personal media platform consisting of LunarMovies, LunarMusic, and LunarGames — a place to stream the DVDs I collect, listen to music, and play games.",
    lha: "LunarMovies",
    lhaDescription: "The LunarMovies app — stream the DVDs I collect on mobile. Part of the LunarHome platform. Available as a private download.",
    gk: "GoedKoopje",
    ...
    descApplications: "The rest of the apps - utilities, tools and the personal stuff.",
  ...
  nl: {
    ...
    scoreboardNameRejected: "Die naam is niet toegestaan - probeer iets anders.",
    scoreboardNewBest: "Nieuw persoonlijk record! Voeg het toe aan het scorebord:",
    ...
    lh: "LunarHome",
    lhDescription: "Mijn persoonlijke mediaplatform bestaande uit LunarMovies, LunarMusic en LunarGames — een plek om de dvd's die ik verzamel te streamen, muziek te luisteren en te gamen.",
    lha: "LunarMovies",
    lhaDescription: "De LunarMovies-app — stream de dvd's die ik verzamel op mobiel. Onderdeel van het LunarHome platform. Privé te downloaden.",
    gk: "GoedKoopje",
    ...
    descApplications: "De rest van de apps - hulpprogramma's, tools en het persoonlijke spul.",
